...
{
    public class RedisJobQueue : IRedisJobQueue, IDisposable
    {
        ...
        public RedisJobQueue(ConnectionMultiplexer connection)
        {
            _id = Guid.NewGuid();
        ...
        public RedisJobQueue(ConnectionMultiplexer connection, JobQueueOptions options) : this(connection)
        {
            _options = options;
        }
